...
python evals/generate_swebench_candidates_vllm.py --dataset-name princeton-nlp/SWE-bench_Verified --split test --model Qwen/Qwen3-32B --num-candidates 8 --request-batch-size 64 --output artifacts/swebench/qwen_candidates_n8.jsonl
python evals/together_batch_swebench.py preflight --model Qwen/Qwen3-32B
python evals/together_batch_swebench.py prepare --model Qwen/Qwen3-32B --existing-candidates artifacts/swebench/qwen_candidates_n8.jsonl --batch-input artifacts/swebench/together_batch_input.jsonl --manifest artifacts/swebench/together_batch_manifest.jsonl
python evals/together_batch_swebench.py submit --batch-input artifacts/swebench/together_batch_input.jsonl --state-output artifacts/swebench/together_batch_state.json
python evals/together_batch_swebench.py wait --batch-id <batch-id> --poll-seconds 60 --state-output artifacts/swebench/together_batch_state.json
python evals/together_batch_swebench.py download --batch-id <batch-id> --output artifacts/swebench/together_batch_output.jsonl --error-output artifacts/swebench/together_batch_errors.jsonl
python evals/together_batch_swebench.py convert --batch-output artifacts/swebench/together_batch_output.jsonl --manifest artifacts/swebench/together_batch_manifest.jsonl --output artifacts/swebench/qwen_candidates_n8.jsonl
